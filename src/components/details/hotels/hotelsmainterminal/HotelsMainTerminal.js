  ...
  return (
    <div className="relative my-6 max-1200:mb-0">
      ...
      <div className="relative flex rounded-md border-2 border-gray-200 max-1200:flex-col">
        <div
          className={`flex-grow pr-8 ${isCityHotelPopupOpen && "bg-blue-100 font-medium text-blue-400"} ${commonBorderStyle} ${commonPadding} ${commonHoverStyle} w-[30.95%] max-1200:w-full`}
        ...
        <div
          className={`w-[170.802px] flex-grow ${commonBorderStyle} ${commonPadding} ${isEntryDateHotelPopupOpen && "bg-blue-100 font-medium text-blue-400"} ${commonHoverStyle}`}
        ...
        <div
          className={`w-[170.802px] flex-grow ${commonBorderStyle} ${commonPadding} ${isExitDateHotelPopupOpen && "bg-blue-100 font-medium text-blue-400"} ${commonHoverStyle}`}
        ...
        <div
          className={`w-[247.885px] flex-grow ${commonPadding} ${commonHoverStyle} ${isReservationHotelPopupOpen && "bg-blue-100 font-medium text-blue-400"}`}
          ref={reservationRef}
