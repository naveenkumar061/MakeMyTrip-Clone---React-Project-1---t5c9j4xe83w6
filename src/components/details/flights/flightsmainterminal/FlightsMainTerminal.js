  ...
  return (
    <div className="relative my-6 max-1200:mb-0">
      ...
      <div className="relative flex rounded-md border-2 border-gray-200 max-1200:flex-col">
        {/* From field */}
        <div
          className={`flex-grow pr-8 ${isFromPopupOpen && "bg-blue-100 font-medium text-blue-400"} ${commonBorderStyle} ${commonPadding} ${commonHoverStyle} w-[30.95%] max-1200:w-full`}
        ...
        {/* To field */}
        <div
          className={`flex-grow max-1200:p-4 ${commonBorderStyle} ${isToPopupOpen && "bg-blue-100 font-medium text-blue-400"} px-12 py-4 pr-4 ${commonHoverStyle} w-[30.95%] max-1200:w-full`}
        ...
        <div
          className={`flex-grow ${commonBorderStyle} ${commonPadding} ${isFlightsDatePopupOpen && "bg-blue-100 font-medium text-blue-400"} ${commonHoverStyle} w-[170.802px]`}
        ...
        <div
          className={`flex-grow ${commonPadding} ${commonHoverStyle} ${isFlightsClassPopupOpen && "bg-blue-100 font-medium text-blue-400"} w-[247.885px]`}
          ref={classRef}
          onClick={handleClass}
        >
          <div className="flex items-center gap-2">
      ...
      <button
        className="absolute right-[66%] top-[45%] z-10 flex h-10 w-10 items-center justify-center rounded-full bg-white text-lg font-bold text-blue-500 shadow-md max-1250:hidden"
