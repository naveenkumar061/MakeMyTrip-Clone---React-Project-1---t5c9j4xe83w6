...
function FlightsMainTerminal() {
  ...
  return (
    <div className="relative my-6 max-1200:mb-0">
      ...
      <button
        className="absolute top-[22.5%] right-1/2 md:top-[45%] md:right-[72%] min-850:right-[72.5%] lg:top-[45%] lg:left-[22.95%] min-1200:left-[28.5%] min-1240:left-[27.5%] xl:top-[40%] xl:-translate-x-0 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-white text-lg font-bold text-blue-500 shadow-md"
