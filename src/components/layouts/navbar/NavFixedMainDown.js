...
function NavFixedMainDown() {
  return (
    <div className="relative z-10 mt-16 flex items-center justify-between gap-8 rounded-md border border-gray-200 bg-white px-8 pt-4 text-gray-700 shadow-md mx-24">
